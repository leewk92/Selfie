...
/**
 * This class is useful to obtain Hue, Saturation, Contrast and Brightness of image file.
 * Referneces : following urls.
...
public class ColorFilterGenerator {
  ...
  */
  ...
  /**
   * this function is used on above static functions. like clamp function.
   * @param p_val
   * @param p_limit
   * @return cleanvalue
   */
  ...
  /**
   * apply color filter with those given data
   * @param brightness
   * @param contrast
   * @param saturation
   * @param hue
