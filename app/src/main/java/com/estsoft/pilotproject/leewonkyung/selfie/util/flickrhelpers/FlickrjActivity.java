...
public class FlickrjActivity extends Activity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    if (getIntent().getExtras() != null) {
      ...
      if (getIntent().getExtras().containsKey("flickImagePath")) {
        mPath = getIntent().getStringExtra("flickr_image_filepath");
        mTitle = getIntent().getStringExtra("flickr_image_title");
      }
    }
  }
  ...
  private void load(OAuth oauth) {
    ...
    if (oauth != null && mPath != null && mTitle != null) {

      UploadPhotoTask taskUpload = new UploadPhotoTask(this, new File(mPath), mTitle);
